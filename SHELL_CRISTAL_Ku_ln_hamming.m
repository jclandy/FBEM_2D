...
save('FEM2D_Simulations_CRISTAL_Ku_Lognormal_Hamming');
...
for i = 1:length(sigma_si)
    ...
    for j = 1:length(sigma_surf_si)
        ...
        % Add echo to results
        save('FEM2D_Simulations_CRISTAL_Ku_Lognormal_Hamming','P_t_full_range','P_t_ml_range','P_t_full_comp_range','P_t_ml_comp_range','EM_bias_range','beta_c','-append');
